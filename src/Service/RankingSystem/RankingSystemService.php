...
//<editor-fold desc="Protected Final Methods">
   ...
   */
  final protected function getEntriesOfPlayers(Collection $players, RankingSystemListInterface $list,
                                               array &$entries): array
  {
    $result = [];
   ...
   */
  protected final function getOrCreateChange(TournamentHierarchyEntity $entity, EntityRankingSystemInterface $ranking,
...
//<editor-fold desc="Protected Methods">
   ...
   */
  protected abstract function updateRankingTimes(\DateTime $from, EntityRankingSystemInterface $rankingSystem);
//</editor-fold desc="Protected Methods">
...
SQL;
    ...
    $query = <<<SQL
INSERT INTO $table ($idCol, $rankingSystemListCol, $playerCol, $pointsCol, $numberRankedEntitiesCol, $subClassDataCol)
SELECT UUID(), ?, b.$playerCol, b.$pointsCol, b.$numberRankedEntitiesCol, b.$subClassDataCol
FROM $table AS b
...
SQL;
   ...
   * @throws \Doctrine\DBAL\DBALException
   */
  private function deleteOldChanges(EntityRankingSystemInterface $rankingSystem, \DateTime $from, \DateTime $to,
